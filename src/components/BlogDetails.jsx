  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-2xl mx-auto px-4 py-8">
        ...
        {typeof showOnlyAuthorBlogs !== "undefined" &&
          typeof onToggleShowAuthorBlogs === "function" && (
            <div className="flex justify-end mb-6">
              <button
                className={`px-3 py-1 rounded-lg border ${
                  showOnlyAuthorBlogs
                    ? "bg-[#6840c6] text-white"
                    : "bg-white text-gray-700"
                } hover:bg-[#6840c6]/80 hover:text-white transition`}
                onClick={() => onToggleShowAuthorBlogs(!showOnlyAuthorBlogs)}
              >
                {showOnlyAuthorBlogs ? "Show All Blogs" : "Show My Blogs Only"}
              </button>
            </div>
          )}
          ...
          {isEditing ? (
            <>
              ...
              <div className="flex gap-4">
                <button
                  onClick={() =>
                    handleSave(blog, editedBlog, setEditedBlog, setIsEditing)
                  }
